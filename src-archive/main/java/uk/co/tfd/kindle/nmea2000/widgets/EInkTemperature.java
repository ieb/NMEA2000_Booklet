...
public class EInkTemperature extends EInkTextBox {
    ...
    public EInkTemperature(boolean rotate, Map<String, Object> options, DisplayConversion.DisplayUnits displayUnits, Store store) {
    ...
    public void onUpdate(Data.DataValue d) {
        if (d.isType(Data.DataType.TEMPERATURE) ) {
            super.onUpdate(d);
        }
    }
