...
public class Instruments {
    ...
    public void addConfiguration(Map<String, Object> configuration) {
        ...
        if (configuration.containsKey("instruments")) {
            ...
            for(Map.Entry<String, Map<String, Object>> e :  instruments.entrySet() ) {
                ...
                try {
                    Class<? extends EInkTextBox> widgetClass = (Class<? extends EInkTextBox>) Class.forName("uk.co.tfd.kindle.nmea2000.widgets." + instrument.get("widget"));
    ...
    public static class Instrument<T extends EInkTextBox> {
        ...
        public Instrument(String name, Class<T> widget, String ... sources) throws NoSuchMethodException {
            ...
            this.constructor = this.widget.getConstructor(boolean.class, Map.class, DisplayConversion.DisplayUnits.class, Store.class);

        }
        public T create(boolean rotation, DisplayConversion.DisplayUnits displayUnits, Store store) throws IllegalAccessException, InvocationTargetException, InstantiationException {
