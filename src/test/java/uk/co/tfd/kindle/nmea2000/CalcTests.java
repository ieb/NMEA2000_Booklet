...
public class CalcTests {
    ...
    public void testObsevables() {
        Data.DataKey nav = new Data.DataKey("nav.datetime", Data.Unit.M,Data.DataType.DISTANCE,"test");
        Data.DataValue o = new Data.DataValue(nav, "na", "na");
